...
\input{tex/utilities.tex}
\input{tex/styles.tex}
\input{tex/dates.tex}               %Import all the dates into events
...
\newcommand{\drawpage}[6]       %\drawpage{left_x}{top_y}{right_x}{bottom_y}{rotate}{file}
{
  ...
  \draw (#1, #2) node[inner sep=0pt,anchor=north west, rotate=#5] {\input{pages/#6}};
}
\begin{document}
  ...
  \node at (current page.center) [rotate=180]
{
  ...
  \begin{scope}[xshift=\xshift]
    ...
    \drawpage{\sideL}{\foldM}{\foldA}{\sideB}{0}{overdue.tex}
  ...
  \node at (current page.center) [rotate=180]
{
  ...
  \begin{scope}[xshift=\xshift]
    ...
    \drawpage{\foldA}{\sideB}{\sideL}{\foldM}{180}{front-page-pdf.tex}
